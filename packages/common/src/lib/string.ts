export function joinTitle(value: (string | undefined | null)[]) {
...
export function joinedStringtoArray(
...
export function escapePhoneNumber(value: string) {
  return value.replace(/[^\d+]/g, "");
}

export function stripPhoneCountryCode(value: string): string {
  return escapePhoneNumber(value).replace(/^\+?\d{1,4}/, "");
}

export function toValidKoreanPhoneNumberOrNull(value: string): string | null {
...
export function maskingPhoneNumber(value: string) {
  return "*".repeat(value.length - 4) + value.slice(-4);
}

export function getLastNumber(value: string) {
...
export function formatNumberKR(num: number): string {
  if (num >= 10000000) {
...
export function extractCleanAddress(address: string): {
